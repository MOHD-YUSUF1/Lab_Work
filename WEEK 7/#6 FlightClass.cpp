// Write a C++ program to implement flight class with data member as flight_no., source destination and fare.
// Write a member function to display the flight information using this pointer.
